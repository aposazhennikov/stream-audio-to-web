...
3. **`playlist/`** - Пакет для управления плейлистами
   - `playlist.go` - Отвечает за сканирование директорий, отслеживание изменений в файловой системе, перемешивание треков.
...
- **playlist** — сканирование директорий и управление плейлистами
- **http** — HTTP-сервер и обработчики запросов
